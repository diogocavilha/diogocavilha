...
- I'm skilled in PHP, TypeScript and ReactJS though I have also some experience with other programming languages such as Python and Java (with Spring Boot) but wouldn't count on that.
